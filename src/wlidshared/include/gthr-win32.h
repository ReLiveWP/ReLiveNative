...
int __gthread_objc_condition_allocate(objc_condition_t __UNUSED_PARAM(condition))
{
  /* Unimplemented.  */
  return -1;
}
...
int __gthread_objc_condition_deallocate(objc_condition_t __UNUSED_PARAM(condition))
{
  /* Unimplemented.  */
  return -1;
}
...
int __gthread_objc_condition_wait(objc_condition_t __UNUSED_PARAM(condition),
...
int __gthread_objc_condition_broadcast(objc_condition_t __UNUSED_PARAM(condition))
{
  /* Unimplemented.  */
  return -1;
}
...
int __gthread_objc_condition_signal(objc_condition_t __UNUSED_PARAM(condition))
{
  /* Unimplemented.  */
  return -1;
}
...
#define __GTHR_W32_InterlockedCompareExchange InterlockedCompareExchange
  ...
  int __gthr_win32_once(__gthread_once_t *, void (*)(void));
  int __gthr_win32_key_create(__gthread_key_t *, void (*)(void *));
  int __gthr_win32_key_delete(__gthread_key_t);
  void *__gthr_win32_getspecific(__gthread_key_t);
  int __gthr_win32_setspecific(__gthread_key_t, const void *);
  void __gthr_win32_mutex_init_function(__gthread_mutex_t *);
  int __gthr_win32_mutex_lock(__gthread_mutex_t *);
  int __gthr_win32_mutex_trylock(__gthread_mutex_t *);
  int __gthr_win32_mutex_unlock(__gthread_mutex_t *);
  void
  __gthr_win32_recursive_mutex_init_function(__gthread_recursive_mutex_t *);
  int __gthr_win32_recursive_mutex_lock(__gthread_recursive_mutex_t *);
  ...
  void __gthr_win32_mutex_destroy(__gthread_mutex_t *);
  int __gthr_win32_recursive_mutex_destroy(__gthread_recursive_mutex_t *);
  ...
  int __gthread_key_create(__gthread_key_t *__key, void (*__dtor)(void *))
  {
  ...
  int __gthread_setspecific(__gthread_key_t __key, const void *__ptr)
  {
...
int __gthread_key_create(__gthread_key_t *__key,
...
void __gthread_mutex_destroy(__gthread_mutex_t *__mutex)
{
...
void __gthread_recursive_mutex_init_function(__gthread_recursive_mutex_t *__mutex)
{
  __mutex->counter = -1;
  __mutex->depth = 0;
  __mutex->owner = 0;
