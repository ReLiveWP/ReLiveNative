...
int __gthr_win32_once(__gthread_once_t *once, void (*func)(void))
{
...
int __gthr_win32_key_create(__gthread_key_t *key,
...
int __gthr_win32_mutex_trylock(__gthread_mutex_t *mutex)
{
...
void __gthr_win32_recursive_mutex_init_function(__gthread_recursive_mutex_t *mutex)
{
  mutex->counter = -1;
  mutex->depth = 0;
  mutex->owner = 0;
...
int __gthr_win32_recursive_mutex_trylock(__gthread_recursive_mutex_t *mutex)
{
  DWORD me = GetCurrentThreadId();
  if (__GTHR_W32_InterlockedCompareExchange(&mutex->counter, 0, -1) < 0)
  {
...
int __gthr_win32_recursive_mutex_unlock(__gthread_recursive_mutex_t *mutex)
{
  --(mutex->depth);
  if (mutex->depth == 0)
  {
...
int __gthr_win32_recursive_mutex_destroy(__gthread_recursive_mutex_t *mutex)
{
  CloseHandle((HANDLE)mutex->sema);
  return 0;
}
